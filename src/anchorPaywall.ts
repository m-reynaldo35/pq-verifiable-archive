...
// GoPlausible's hosted facilitator — handles txn verification and broadcast.
// Self-hosters can point X402_FACILITATOR_URL at their own instance.
const FACILITATOR_URL =
  process.env.X402_FACILITATOR_URL ?? 'https://facilitator.x402.goplausible.xyz';
